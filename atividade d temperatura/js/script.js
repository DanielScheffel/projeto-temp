...
document.querySelector("#button-fahrenheit").onclick = function(){
    ...
    celsiusInput.setAttribute("placeholder", + (fahrenheit - 32)*(9/5).toFixed(3));
    kelvinInput.setAttribute("placeholder", + ((fahrenheit - 32)*(9/5) + 273.15).toFixed(3));
    rankineInput.setAttribute("placeholder", + (fahrenheit + 459.67).toFixed(3));
...
document.querySelector("#button-kelvin").onclick = function(){
    ...
    celsiusInput.setAttribute("placeholder", + (kelvin - 273.15).toFixed(3));
    fahrenheitInput.setAttribute("placeholder", + ((kelvin - 273.15)*(9/5) + 32).toFixed(3));
    rankineInput.setAttribute("placeholder", + ((kelvin - 32)*(5/9) + 273.15).toFixed(3));
...
document.querySelector("#button-rankine").onclick = function(){
    ...
    celsiusInput.setAttribute("placeholder", + (rankine - 491.67)*(5/9).toFixed(3));
    fahrenheitInput.setAttribute("placeholder", + (rankine - 459.67).toFixed(3));
    kelvinInput.setAttribute("placeholder", + (rankine * (5/9)).toFixed(3));
